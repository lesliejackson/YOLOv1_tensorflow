...
conv1_weights = tf.Variable(tf.truncated_normal([3, 3, NUM_CHANNELS, 64], stddev=0.1, seed=SEED, dtype=tf.float32))
conv1_biases = tf.Variable(tf.zeros([64], dtype=tf.float32))
conv2_weights = tf.Variable(tf.truncated_normal([3, 3, 64, 128], stddev=0.1, seed=SEED, dtype=tf.float32))
conv2_biases = tf.Variable(tf.constant(0.1, shape=[128], dtype=tf.float32))


fc1_weights = tf.Variable(tf.truncated_normal([IMAGE_SIZE * IMAGE_SIZE //16  * 128, 128], stddev=0.1, seed=SEED, dtype=tf.float32))
fc1_biases = tf.Variable(tf.constant(0.1, shape=[128], dtype=tf.float32))
fc2_weights = tf.Variable(tf.truncated_normal([128, S*S*(B*5+CLASSES)], stddev=0.1, seed=SEED, dtype=tf.float32))
