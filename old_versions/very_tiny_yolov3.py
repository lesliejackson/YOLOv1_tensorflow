...
TEST_IMG_DIR = '/home/yy/train/'
TEST_LABEL_DIR = 'home/yy/labels/'
RES_DIR = '/home/yy/subnets/'
SAVE_MODEL = '/home/yy/tf_saver_models/model_subnets.ckpt'
...
def model(data, train=False):
  ...
  coors = tf.matmul(fc1_out, fc2_weights) + fc2_biases
  ...
  probs = tf.matmul(fc3_out, fc4_weights) + fc4_biases
  output = []
...
def main(argv=None):
  ...
  with tf.Session() as sess:
    ...
    test_from_dir(TEST_IMG_DIR, display_loss=True)
